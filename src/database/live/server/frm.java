...
public class frm extends javax.swing.JFrame {
    ...
    public void lread() throws ClassNotFoundException{
...
//            url="jdbc:mysql://"+url+":"+port+"/"+root;
            ...
            System.out.println("jdbc:mysql://sql12.freemysqlhosting.net:3306/sql12361343".matches(url));
    ...
    private void initComponents() {
        ...
        setTitle("Database Live Server- Develop By Mithun");
        setResizable(false);
